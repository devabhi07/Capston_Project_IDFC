...
class Register extends React.Component {
  ...
  registerUser(event) {
    if (this.state.passwordDifferent) {
      ...
      axios
        .post("/api/" + this.state.userType + "/register", {
  ...
  render() {
    return (
      ...
      <Grid container>
         <Grid item xs={7}>
          <img className="image" alt="foodImage" src='https://png.pngtree.com/png-clipart/20220131/original/pngtree-big-isolated-motorcycle-vector-colorful-icons-flat-illustrations-of-delivery-by-png-image_7255146.png' />
        </Grid>
            ...
            <div className="container">
              ...
              <form onSubmit={this.registerUser}>
                ...
                <Typography variant="body2" color="error">
                  {this.state.passwordDifferent ? (
                    <i>Password doesn't match</i>
                  ) : null}
                </Typography>
                <TextField
                  variant="outlined"
