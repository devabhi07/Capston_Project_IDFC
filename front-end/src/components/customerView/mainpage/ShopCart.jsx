    ...
    return this.props.currentUser && this.state.orders ? (
      <div>
        <Grid container justify="space-evenly" spacing={3}>
          ...
          )) : <Typography variant="h5"><img className="image" alt="foodImage" src='https://cdni.iconscout.com/illustration/premium/preview/online-food-order-3895939-3444813.png?w=0&h=700' /></Typography>}
